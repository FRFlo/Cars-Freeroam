Citizen.CreateThread(function()
	...
	-- AUTRE
	AddTextEntry('fnvan', 'Van Fortnite')
	-- BENTLEY
	...
	-- POLICE
	AddTextEntry('valor13tahoe', 'Chevrolet Tahoe Sheriff')
	AddTextEntry('valor14charg', 'Dodge Charger Sheriff')
	AddTextEntry('valor15f150', 'Ford Raptor F150 Sheriff')
	AddTextEntry('valor16fpiu', 'Ford Explorer Sheriff')
	AddTextEntry('valor18charg', 'Dodge Charger Sheriff')
	AddTextEntry('valor18chargk9', 'Dodge Charger Sheriff')
	AddTextEntry('valor18tahoe', 'Chevrolet Tahoe Sheriff')
	AddTextEntry('valor18tahoek9', 'Chevrolet Tahoe Sheriff')
	AddTextEntry('valor19silv', 'Chevrolet Silverado Sheriff')
	AddTextEntry('valor20fpiu', 'Ford Explorer Hybride Sheriff')
	AddTextEntry('valor20ram', 'Dodge Ram 1500 Sheriff')
	AddTextEntry('valorcap', 'Chevrolet Caprice Sheriff')
	AddTextEntry('valorcvpi', 'Ford Crown Victoria Sheriff')
	AddTextEntry('valorcvpik9', 'Ford Crown Victoria K9 Sheriff')
	AddTextEntry('valorf250', 'Ford Raptor F250 Sheriff')
	AddTextEntry('valorfpis', 'Ford Torus Sheriff')
	AddTextEntry('valorgmc', 'GMC Sierra Sheriff')
	AddTextEntry('valorharley', 'Haley Davidson Sheriff')
	AddTextEntry('valorram', 'Dodge Ram 2500 Sheriff')=
	AddTextEntry('03expeditionr', 'Ford Expedition XLT LSPD')
	AddTextEntry('11caprice', 'Chevrolet Caprice LSPD')
	AddTextEntry('14charger', 'Dodge Charger 2014 LSPD')
	AddTextEntry('16explorer', 'Ford Explorer LSPD')
	AddTextEntry('16taurus', 'Ford Taurus LSPD')
	AddTextEntry('18charger', 'Dodge Charger 2018 LSPD')
	AddTextEntry('18tahoe', 'Chevrolet Tahoe LSPD')
	AddTextEntry('19durango', 'Dodge Durango LSPD')
	AddTextEntry('newvic', 'Crown Victoria LSPD')
	-- PORSCHE
