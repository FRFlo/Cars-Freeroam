Locales['br'] = {
  ...
  ['command_setteam'] = 'atribuir um trabalho a um usuario',
  ['command_setteam_team'] = 'o trabalho que voce deseja atribuir',
  ['command_setteam_grade'] = 'o nivel de emprego',
  ['command_setteam_invalid'] = 'the team, grade or both are invalid',
