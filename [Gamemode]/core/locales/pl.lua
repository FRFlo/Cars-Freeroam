Locales['pl'] = {
  ...
  ['command_setteam'] = 'ustaw prace dla gracza',
  ['command_setteam_team'] = 'nazwa pracy',
  ['command_setteam_grade'] = 'stanowisko w pracy',
  ['command_setteam_invalid'] = 'praca, stanowisko lub obydwa są nieprawidłowe',
