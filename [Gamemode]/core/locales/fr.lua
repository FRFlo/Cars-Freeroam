Locales['fr'] = {
  ...
  ['command_setteam'] = 'assigner team à un joueur',
  ['command_setteam_team'] = 'nom du team',
  ['command_setteam_grade'] = 'grade du team',
  ['command_setteam_invalid'] = 'le team, le grade ou les deux sont invalides',
