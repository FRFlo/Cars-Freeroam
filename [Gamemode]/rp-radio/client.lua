...
Radio.Commands = {
	{
		...
		Help = "Activer / Désactiver l'interface radio", -- Command help shown in chatbox when typing the command
		Params = {},
	...
	},
	{
		...
		Params = {
			{name = "fréquence", "Entrez la fréquence"}
		},
		Handler = function(src, args, raw)
			if Radio.Has then
				if args[1] then
