...
AddEventHandler('playerJoining', function()
    ...
    TriggerClientEvent('chatMessage', -1, '', { 87, 242, 135 }, '^2* ' .. GetPlayerName(source) .. ' a rejoint le serveur.')
end)
...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerClientEvent('chatMessage', -1, '', { 237, 66, 69 }, '^2* ' .. GetPlayerName(source) ..' a quitté le serveur (' .. reason .. ')')
end)
